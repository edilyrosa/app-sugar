...
// --- ESTILOS PARA EL WRAPPER CON RING Y ANIMACIÓN ---
  ...
  //const ringColor = interpolateColor("ff000", "fffff", progress); // rojo a negro
  ...
  const styleRings: CSSProperties = {
    ...
    opacity: 1, // la imagen se desvanece con el scroll
    borderRadius: "2rem",
    boxShadow: `0 0 0 5px white`,
    transform: `rotate(${wrapperRotate-18}deg)`,
    transition: "background-image 5s, box-shadow 2s, transform 1s opacity 2s",
  ...
  const styleImage: CSSProperties = {
    transform: `rotate(${imgRotate-15}deg)`,
              ...
              >
                <div className="m-2 rounded-lg ring-2 ring-white">
                  <Image
                    src={card}
                    alt="card"
                    className="object-contain  rounded-lg ring-1 ring-white"
                    style={styleImage}
                    draggable={false}
                  />
                </div>
