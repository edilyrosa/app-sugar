...
//             src={card}
//             alt="card"
//             className="object-contain w-full h-full p-6 ring-10 ring-white"
//             draggable={false}
//           />
//         </div>
//       </div>
      ...
      >
        ...
        >
          ...
          <Image
            src={card}
            alt="card"
            // The image itself should just fill its container now
            className="object-contain p-6 ring-10 ring-white"
            draggable={false}
          />
        </div>
      </div>
