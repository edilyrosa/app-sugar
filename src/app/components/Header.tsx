import { poppins } from '@/app/components/utils/fonts'; // Adjust path as needed
...
export default function Header() {
    return  (
        <header className={`
            ...
            <div className="bg-black text-white font-semibold rounded-4xl p-4 mr-6">VIEW METAMASK WEB</div>
